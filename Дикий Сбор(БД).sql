...
Таблица грибов (mushrooms) имеет внешний ключ category_id, который связывает её с таблицей категорий (categories). Этот ключ указывает на категорию каждого гриба.

Таблица грибов (mushrooms) также имеет внешний ключ primary_region_id, который связывает её с таблицей регион сбора грибов (regions). Этот ключ указывает на место, где лучше всего собирать каждый гриб.
